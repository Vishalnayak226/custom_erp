...
*   **Build Handover Milestone**:
    ...
    - **Stage 18 (added 2026-07-19, not started).** New backlog item per explicit user request: audit and rework data-entry forms so master/reference fields (Chart of Accounts, Item category, location codes, vendor/customer, etc.) use dropdowns/type-ahead instead of free text — see `docs/micro_checklist.md` Stage 18 for the placeholder breakdown (18.1-18.4). Not yet scoped into implementation-sized work.
