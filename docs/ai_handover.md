...
- **Uncommitted as of this note**: Stage 26 planning docs (below) plus a new WMS-retirement docs pass (below) — not yet committed. Check `git status` before assuming HEAD reflects everything described here; this tree sees concurrent sessions.
